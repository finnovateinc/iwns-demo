...
import NavsHeaderXC from './navs-header-xc';
import NavsFooterXC from './navs-footer-xc';
...
const wide = {
  full: [{xs: 0, sm: 0, md: 0, lg: 0}, {xs: 24, sm: 24, md: 24, lg: 24}],
  wide: [{xs: 0, sm: 0, md: 0, lg: 0}, {xs: 24, sm: 24, md: 24, lg: 24}],
  medium: [{xs: 0, sm: 0, md: 6, lg: 4}, {xs: 24, sm: 24, md: 12, lg: 16}],
  small: [{xs: 0, sm: 0, md: 6, lg: 8}, {xs: 24, sm: 24, md: 12, lg: 8}],
  mini: [{xs: 0, sm: 0, md: 6, lg: 9}, {xs: 24, sm: 24, md: 12, lg: 6}],
}
    ...
    <>
            ...
            <Col {...wide[props.head][1]}>
              <Row justify="space-between">
                ...
                <Col xs={0} md={18} className="text-center">
                  <Row align='middle' justify='center'> <NavsHeaderXC /> </Row>
                </Col>
                ...
                <Col span={3} className="text-end" ><UserAvatar /></Col>
              </Row>
            </Col>
            <Col {...wide[props.head][0]}></Col>
      ...
      <Footer className="back-color-lite m-0 px-0">
        <Row>
          ...
          <Col xs={{span:0}} md={{span:0}}>

            <div className='py-2 border-top' style={{position:'fixed', bottom:'0rem', backgroundColor: 'white', width: '100%', textAlign:'center'}}>
              <NavsFooterXC />
            </div>
          </Col>
        </Row>
